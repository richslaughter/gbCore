...
namespace GbCoreTests
{
    ...
    public class MmuTests
    {
        ...
        {
            var mmu = new Mmu(_bios);
            var result = mmu.ReadWord(0x00);
            Assert.AreEqual(0xFE31, result);
        }
    }
}
